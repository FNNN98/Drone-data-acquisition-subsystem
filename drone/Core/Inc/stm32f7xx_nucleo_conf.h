...
#ifndef STM32F7XX_NUCLEO_CONF_H
#define STM32F7XX_NUCLEO_CONF_H
...
/** @defgroup STM32F7XX_NUCLEO_CONFIG Config
  * @{
  */

/** @defgroup STM32F7XX_NUCLEO_CONFIG_Exported_Constants
  * @{
  */
/* COM Feature define */
